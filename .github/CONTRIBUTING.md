...
* It's easiest to try out your changes within the Stylus editor.
  ...
  * Once done, make the same changes to the `github-feed-icons.user.css` file in the repo and save. It might be easiest to copy &amp; paste the entire style from the Stylus editor.
